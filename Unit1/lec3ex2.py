...
Using the Graph class created in the lecture, we can create a graph with the design chosen in Exercise 1: vertices represent permutations of the students in line;
...
This problem requires us to plot a Graph(not digraph) {In a graph CBA>> CAB && CAB >>CBA : it is bi-directional whereas digraph is one direction}
"""
